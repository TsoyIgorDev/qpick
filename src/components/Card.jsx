...
const Card = ({ id, imgURL, title, rate, price, oldprice }) => {
    ...
    return (
        <div className='bg-white w-full h-101.75 rounded-3xl shadow-[0px_0px_20px_1px_rgba(0,0,0,0.1)] pt-3.75 px-4.5 pb-6.5 flex items-center flex-col justify-center gap-14 hover:scale-105 transition duration-200'>
            <div className='flex justify-center items-center h-[220px] w-[237px]'>
                <img src={imgURL} alt="" className='bg-auto' />
            </div>
